...
public class SearchPairing extends AppCompatActivity {
    //BluetoothAdapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_pairing);
        //UI
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch(action){
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_STARTED:
                    ...
                    Toast.makeText(SearchPairing.this, "블루투스 검색 시작", Toast.LENGTH_SHORT).show();
                    break;
                //블루투스 디바이스 찾음
                ...
                case BluetoothAdapter.ACTION_DISCOVERY_FINISHED:
                    Toast.makeText(SearchPairing.this, "블루투스 검색 종료", Toast.LENGTH_SHORT).show();
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (state){
                ...
                case BluetoothAdapter.SCAN_MODE_NONE:
                    ...
                    Toast.makeText(SearchPairing.this, "검색응답 모드 종료", Toast.LENGTH_SHORT).show();
                    break;
                case BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE:
                    Toast.makeText(SearchPairing.this, "다른 블루투스 기기에서 내 휴대폰을 찾을 수 있습니다.", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
