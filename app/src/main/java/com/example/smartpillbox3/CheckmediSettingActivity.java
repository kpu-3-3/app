...
public class CheckmediSettingActivity extends AppCompatActivity {
    medisettingAdapter adapter;
    ListView listView;
    //    private ListView boardListView;
////    private postListAdapter adapter;
    private List<usermedi_item> medisettingList;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_checkmedi_setting);

        // Adapter 생성
        adapter = new medisettingAdapter() ;

        // 리스트뷰 참조 및 Adapter달기
        listView = (ListView) findViewById(R.id.medisettingListView);
